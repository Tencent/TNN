...
#ifndef TNN_SOURCE_DEVICE_X86_OPENVINO_NETWORK_H_
#define TNN_SOURCE_DEVICE_X86_OPENVINO_NETWORK_H_
...
class OpenVINONetwork:public AbstractNetwork {
public:
    // @brief virtual default destructor
    virtual ~OpenVINONetwork();
...
#endif  // TNN_SOURCE_DEVICE_X86_OPENVINO_NETWORK_H_
