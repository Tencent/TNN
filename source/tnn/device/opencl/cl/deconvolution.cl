...
__kernel void Deconv2DGS3D(GLOBAL_SIZE_3_DIMS __read_only image2d_t input, __read_only image2d_t weights,
...
__kernel void DepthwiseDeconv2DGS3D(GLOBAL_SIZE_3_DIMS __read_only image2d_t input, __read_only image2d_t weights,
                                    __read_only image2d_t bias,
                                    __write_only image2d_t output,
                                    __private const int2 input_wh,
                                    __private const int2 output_wh,
