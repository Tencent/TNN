...
__kernel void MatMul6D(GLOBAL_SIZE_2_DIMS __read_only image2d_t matrix_a, __read_only image2d_t matrix_b,
    ...
    for (int k = 1; k <= K; k++) {
        in0 = read_imagef(matrix_a, SAMPLER, (int2)(matrix_a_ix, matrix_a_iy));
        in1 = read_imagef(matrix_b, SAMPLER, (int2)(matrix_b_ix, matrix_b_iy));
    ...
    write_imagef(matrix_c, (int2)(image_row, image_col), sum);
}
