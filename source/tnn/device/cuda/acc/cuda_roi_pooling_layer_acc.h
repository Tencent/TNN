...
#ifndef TNN_SOURCE_DEVICE_CUDA_CUDA_ROI_POOLING_LAYER_ACC_H_
#define TNN_SOURCE_DEVICE_CUDA_CUDA_ROI_POOLING_LAYER_ACC_H_
...
class CudaRoiPoolingLayerAcc : public CudaLayerAcc {
public:
    /**
    ...
    virtual ~CudaRoiPoolingLayerAcc() override;
...
private:
     ...
     * @return execution result
     */
    Status Forward2D(const std::vector<Blob *> &inputs,
     ...
     * @return execution result
     */
    Status Forward3D(const std::vector<Blob *> &inputs,
                     const std::vector<Blob *> &outputs);
};

}  // namespace TNN_NS

#endif  // TNN_SOURCE_DEVICE_CUDA_CUDA_ROI_POOLING_LAYER_ACC_H_
