...
|---------------------------|----------|-----|-------|-------|--------|-------|------|------|------|------|
| AlexNet                   | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| DenseNet(121)             | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| FCN                       | Yes      | yes |       |       |        | yes   |  -   | yes  |      |      |
...
| MobileNet-v1-ssd(pytorch) | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| MobileNet-v2-SSDLite      | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| MobileNet-yolov3          | ?        | ?   |       |       |        |       |      |      |      |      |
| MobileNet-v1              | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| MobileNet-v2              | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| MobileNet-v3(small,large) | yes      | yes |       |       |        | yes   | No   | yes  |      |      |
| Mtcnn-v2                  | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| PSPNet                    | yes      | yes |       |       |        | yes   | No   | yes  |      |      |
| ResNet50                  | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| SENet(154)                | yes      | yes |       |       |        | yes   |  -   | yes  |      |      |
| ShuffleNet-v1             | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| ShuffleNet-v2             | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| SqueezeNet-ssd            | No       | -   | -     | -     | -      | -     |  -   |  -   |      |      |
| SqueezeNet-v1             | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| UNet                      | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| Vgg-ssd                   | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| Vgg16                     | yes      | yes |       |       |        | yes   | yes  |      |      |      |
| Yolo-v3-tiny              | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| Yolo-v2                   | ?        | ?   |       |       |        | yes   | yes  |      |      |      |
| Yolo-v2-tiny              | yes      | yes |       |       |        | yes   | yes  | yes  |      |      |
| Yolo-v3                   | yes      | yes |       |       |        | yes   | -    | yes  |      |      |
...
| Acos                     | Acos                                           | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Add                      | Add                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| ArgMaxOrMin(ArgMax)      | ArgMax                                         | yes | yes   | yes   |        | yes   |       | yes   |       |       |
| ArgMaxOrMin(ArgMin)      | ArgMin                                         | yes | yes   | yes   |        | yes   |       | yes   |       |       |
| Asin                     | Asin                                           | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Atan                     | Atan                                           | yes | yes   | yes   | yes    | yes   |       | yes   |       |       |
| BatchNormCxx             | BatchNormalization                             | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| BitShift                 | BitShift                                       | yes |       |       |        |       |       | yes   |       |       |
| Cast                     | Cast                                           |     | yes   | yes   |        | yes   | yes   | yes   |       |       |
| Ceil                     | Ceil                                           | yes | yes   | yes   |        | yes   | yes   | yes   |       |       |
| Clip                     | Clip                                           | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
...
| Cos                      | Cos                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Deconvolution            | ConvTranspose                                  | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Deconvolution(depthwise) | ConvTranspose                                  | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Deconvolution(group)     | ConvTranspose                                  | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| DetectionOutput          | DectectionOutput(custom operator)              | yes | yes   | yes   |        |       |       | yes   |       |       |
| Div                      | Div                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Dropout                  | Dropout                                        |     |       |       |        |       |       |       |       |       |
...
| Expand                   | Expand                                         | yes | yes   | yes   |        |       |       | yes   |       |       |
| Flatten                  | Flatten                                        |     | yes   | yes   |        | yes   | yes   | yes   |       |       |
| Flatten                  | Shape+Gather+Constant+Unsqueeze+Concat+Reshape |     |       |       |        |       |       |       |       |       |
| Floor                    | Floor                                          | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Gather                   | Gather                                         |     | yes   | yes   |        | yes   | yes   | yes   |       |       |
| GatherND                 | GatherND                                       | yes |       |       |        |       |       | yes   |       |       |
| GridSample               | GridSample(PyTorch)                            | yes |       |       |        |       |       | yes   |       |       |
| GroupNorm                | GroupNorm(PyTorch)                             | yes |       |       |        |       |       | yes   |       |       |
| HardSigmoid              | HardSigmoid                                    | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| HardSwish                | Add + Clip + Div + Mul                         | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| HardSwish                | Add + Clip + Mul + Div                         | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| HardSwish                | HardSigmoid + Mul                              | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| InnerProduct             | Gemm                                           | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| InstBatchNormCxx         | InstanceNormalization                          | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Inverse                  | Inverse(PyTorch)                               | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| LSTMONNX                 | LSTM                                           | yes | yes   | yes   |        | yes   |       | yes   |       |       |
| LRN                      | LRN                                            | yes |       |       |        | yes   | yes   | yes   |       |       |
| Log                      | Log                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| LogSigmoid               | Sigmoid + Log                                  | yes | yes   | yes   | yes    | yes   |       | yes   |       |       |
| MatMul                   | Matmul                                         |     | yes   | yes   |        | yes   | yes   | yes   |       |       |
| Max                      | Max                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Min                      | Min                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Mul                      | Mul                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Neg                      | Neg                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| NonZero                  | NonZero                                        | yes |       |       |        |       |       |       |       |       |
| Normalize                | ReduceL2+Clip+Shape+Expand+Div                 | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Normalize                | Reduce + Clip + Expand + Div                   | yes | yes   | yes   | yes    | yes   |       | yes   |       |       |
| Normalize                | Mul(square)+Reduce+Max+Sqrt+Mul                | yes | yes   | yes   | yes    | yes   |       | yes   |       |       |
| OneHot                   | OneHot                                         | yes |       |       |        |       |       | yes   |       |       |
| PRelu                    | LeakyRelu / PRelu                              | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Pad                      | Pad                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Permute                  | Transpose                                      | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| PixelShuffle             | PixelShuffle(PyTorch), Depth2Space(ONNX)       | yes | yes   | yes   |        | yes   |       | yes   |       |       |
...
| Power                    | Pow                                            | yes | yes   | yes   | yes    | yes   |       | yes   |       |       |
| PriorBox                 | PriorBox(custom operator)                      | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Range                    | Range                                          | yes |       |       |        |       |       |       |       |       |
| Reciprocal               | Reciprocal                                     | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| ReduceL1                 | ReduceL1                                       | yes | yes   | yes   |        | yes   |       |       |       |       |
| ReduceL2                 | ReduceL2                                       | yes | yes   | yes   |        | yes   |       | yes   |       |       |
| ReduceLogSum             | ReduceLogSum                                   | yes | yes   | yes   |        | yes   |       |       |       |       |
| ReduceLogSumExp          | ReduceLogSumExp                                | yes | yes   | yes   |        | yes   | yes   | yes   |       |       |
| ReduceMax                | ReduceMax                                      | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| ReduceMean               | ReduceMean                                     | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| ReduceMin                | ReduceMin                                      | yes | yes   | yes   |        | yes   | yes   | yes   |       |       |
| ReduceProd               | ReduceProd                                     | yes | yes   | yes   |        | yes   | yes   |       |       |       |
...
| ScatterND                | ScatterND                                      | yes |       |       |        |       |       | yes   |       |       |
| Selu                     | Selu                                           | yes | yes   | yes   | yes    | yes   | yes   |       |       |       |
...
| Sign                     | Sign                                           | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| SignedMul                | Sub+Sign+Add+Div+Gather+Slice+Mul              |     | yes   | yes   |        |       |       |       |       |       |
| Sin                      | Sin                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Size                     | Size                                           | yes |       |       |        |       |       |       |       |       |
| Slice(StrideSlice)       | Slice                                          | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Softmax                  | Softmax                                        | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Softplus                 | Softplus                                       | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Softsign                 | Softsign                                       | yes |       |       |        |       |       |       |       |       |
| Split                    | Split                                          |     | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Sqrt                     | Sqrt                                           | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| SquaredDifference        | SquaredDifference(TFLite)                      | yes |       |       |        |       |       |       |       |       |
| Squeeze                  | Squeeze                                        |     | yes   | yes   |        | yes   | yes   | yes   |       |       |
| Sub                      | Sub                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Sum                      |                                                |     |       |       |        |       |       |       |       |       |
| Tan                      | Tan                                            | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Tanh                     | Tanh                                           | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Tile                     | Tile                                           | yes |       |       |        |       |       | yes   |       |       |
| Unsqueeze                | Unsqueeze                                      | yes | yes   | yes   |        | yes   | yes   | yes   |       |       |
| Upsample                 | Upsample / Resize                              | yes | yes   | yes   | yes    | yes   | yes   | yes   |       |       |
| Where                    | Where                                          | yes |       |       |        |       |       |       |       |       |
