...
- align parameter (optional)
    You can optimize the model with the "-align" parameter. Compare TNN model and original model to determine whether TNN model is correct. If you remove "-align", model align will not run; If you use "-align output", this tool will compare the last output of TNN model and original model; If you use "-align all", this tool will compare all the layer of TNN and original model.
