...
3. 设置开发者账号
   ...
   <div align=left ><img src="./resource/ios_add_account_benchmark.jpg" width = "75%" height = "75%"/>
...
4. 真机运行  
   ...
   <div align=left ><img src="./resource/ios_set_bundleid_benchmark.jpg" width = "75%" height = "75%"/>
   ...
   <div align=left ><img src="./resource/ios_verify_certificate_benchmark.jpg" width = "75%" height = "75%"/>

   4.3 运行结果

   首次运行先利用快捷键`Command + Shift + K`对工程进行清理，再执行快捷键`Command + R`运行。在界面上点击Run按钮，界面会显示model目录下所有模型的CPU和GPU耗时情况。iPhone7真机运行结果如下图。

   <div align=left ><img src="./resource/ios_benchmark_result.jpg" width = "50%" height = "50%"/>
...
```
结果如图：
<div align=left ><img src="./resource/android_profiling.jpg" width = "75%" height = "75%"/>
...
```
结果如图：
<div align=left ><img src="./resource/opencl_profiling.jpg" width = "75%" height = "75%"/>
