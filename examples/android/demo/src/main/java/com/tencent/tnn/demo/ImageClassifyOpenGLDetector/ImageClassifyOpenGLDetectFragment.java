package com.tencent.tnn.demo.ImageClassifyOpenGLDetector;
...
import com.tencent.tnn.demo.ImageClassifyOpenGL;
...
public class ImageClassifyOpenGLDetectFragment extends BaseFragment {

    private final static String TAG = ImageClassifyOpenGLDetectFragment.class.getSimpleName();
    private ImageClassifyOpenGL mImageClassifyOpenGL = new ImageClassifyOpenGL();
    ...
    private void startDetect() {
        ...
        int result = mImageClassifyOpenGL.init(modelPath, NET_INPUT, NET_INPUT, device);
        if (result == 0) {
            Log.d(TAG, "detect from image");
            int [] indexArray= mImageClassifyOpenGL.detectFromImage(scaleBitmap, NET_INPUT, NET_INPUT);
