...
public class ImageClassifyOpenGLDetectActivity extends DemoBaseActivity {
    private static final String TAG = ImageClassifyOpenGLDetectActivity.class.getSimpleName();
    ...
    public void updateUI() {
        Fragment fragment = new ImageClassifyOpenGLDetectFragment();
