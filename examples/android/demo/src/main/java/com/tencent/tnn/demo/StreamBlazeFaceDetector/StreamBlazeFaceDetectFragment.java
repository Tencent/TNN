                ...
                mOpenedCamera.setPreviewCallback(new Camera.PreviewCallback() {
                    ...
                    public void onPreviewFrame(byte[] data, Camera camera) {
                        if (mIsDetectingFace) {
                            ...
                            BlazeFaceDetector.BlazeFaceInfo[] faceInfoList = mFaceDetector.detectFromStream(data, mCameraWidth, mCameraHeight, mRotate);
                            Log.i(TAG, "detect from stream ret " + faceInfoList);
                            int faceCount = 0;
                            if (faceInfoList != null) {
                                faceCount = faceInfoList.length;
                            }
//                            mDrawView.addFaceRect(faceInfoList, mCameraHeight, mCameraWidth);
