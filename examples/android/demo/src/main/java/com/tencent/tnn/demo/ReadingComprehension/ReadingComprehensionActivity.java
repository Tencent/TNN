...
import com.tencent.tnn.demo.ImageObjectDetector.ImageObjectDetectFragment;
import com.tencent.tnn.demo.R;
import com.tencent.tnn.demo.common.activity.DemoBaseActivity;

public class ReadingComprehensionActivity extends DemoBaseActivity {
    private static final String TAG = ReadingComprehensionActivity.class.getSimpleName();
    ...
    public void updateUI() {
        Fragment fragment = new ReadingComprehensionFragment();
