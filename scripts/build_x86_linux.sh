...
# 编译 openvino 库
if [ ! -d ${TNN_DIR}/scripts/build_x86 ]
then
mkdir build_x86
fi
...
if [ ! -d ${TNN_DIR}/scripts/build_x86/openvinoInstall ]
then
# TNN/scripts/build_x86
git clone https://github.com/openvinotoolkit/openvino.git
cd openvino
git reset --hard 9df6a8f

# TNN/scripts/build_x86/openvino
...
# TNN/scripts/build_x86/openvino/build
cmake ../ \
-DENABLE_OPENCV=OFF \
