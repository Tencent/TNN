...
if [ ! -f "${OHOS_NATIVE_HOME}/build/cmake/ohos.toolchain.cmake" ]; then
   echo -e "Not found: build/cmake/ohos.toolchain.cmake in OHOS_NATIVE_HOME:$OHOS_NATIVE_HOME"
   echo -e "Please download Harmony SDK and set OHOS_NATIVE_HOME environment variable."
   exit -1
fi
