...
if not exist !TNN_DIR!\scripts\build_x86\ (
    mkdir build_x86
)
cd build_x86

if not exist !TNN_DIR!\scripts\build_x86\openvino (
...
set OPENVINO_DIR=!TNN_DIR!\scripts\build_x86\openvino
...
set "sed=!TNN_DIR!\scripts\build_x86\openvino\sed\sed.exe"
echo !sed!
...
-DENABLE_OPENCV=OFF ^
-DCMAKE_INSTALL_PREFIX="!TNN_DIR!\scripts\build_x86\openvinoInstall" ^
-DENABLE_CLDNN=OFF ^
...
xcopy /s/e/y "!TNN_DIR!\scripts\build_x86\openvinoInstall\deployment_tools\inference_engine\include" "!thirdparty_dir!\openvino\include\"
...
xcopy /s/e/y "!TNN_DIR!\scripts\build_x86\openvinoInstall\deployment_tools\ngraph\include" "!thirdparty_dir!\ngraph\include\"
