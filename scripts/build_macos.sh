...
# 编译 openvino 库
if [ ! -d ${TNN_DIR}/scripts/build_macos ]
then
mkdir build_macos
fi
...
if [ ! -d ${TNN_DIR}/scripts/build_macos/openvinoInstall ]
then
# TNN/scripts/build_macos
git clone https://github.com/openvinotoolkit/openvino.git
cd openvino
git reset --hard 9df6a8f

# TNN/scripts/build_macos/openvino
...
# TNN/scripts/build_macos/openvino/build
cmake ../ \
-DENABLE_OPENCV=OFF \
-DCMAKE_INSTALL_PREFIX=${TNN_DIR}/scripts/build_macos/openvinoInstall \
-DENABLE_CLDNN=OFF \
...
# TNN/scripts/build_macos/ 拷贝 lib 和 include 文件到 thirdparty 下
